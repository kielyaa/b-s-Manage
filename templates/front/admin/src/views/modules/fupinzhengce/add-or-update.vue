	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"50px 0 30px 0","margin":"0","overflow-y":"auto","background":"#fff","height":"auto"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else class="input" label="适用对象" prop="shiyongduixiang">
					<el-input v-model="ruleForm.shiyongduixiang" placeholder="适用对象" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="颁布日期" prop="banburiqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.banburiqi" 
						type="date"
						:readonly="ro.banburiqi"
						placeholder="颁布日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.banburiqi" label="颁布日期" prop="banburiqi">
					<el-input v-model="ruleForm.banburiqi" placeholder="颁布日期" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"margin":"0 0 20px 0"}' class="textarea" v-if="type!='info'" label="政策内容" prop="zhengceneirong">
					<el-input
				...
				<el-form-item :style='{"margin":"0 0 20px 0"}' v-else-if="ruleForm.zhengceneirong" label="政策内容" prop="zhengceneirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}'>{{ruleForm.zhengceneirong}}</span>
				</el-form-item>
...
export default {
	...
	created() {
		this.ruleForm.banburiqi = this.getCurDate()
	},
	methods: {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='banburiqi'){
							this.ruleForm.banburiqi = obj[o];
							this.ro.banburiqi = true;
							continue;
						}
				}
