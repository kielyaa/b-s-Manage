<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"0","margin":"0","borderColor":"#fff","top":"170px","background":"#fff","borderWidth":"10px 0 0","width":"calc(100% - 0px)","lineHeight":"24px","position":"fixed","borderStyle":"solid","zIndex":"999"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"padding":"0 0 0 40px","borderColor":"#8696b0","whiteSpace":"nowrap","background":"#fff","borderWidth":"0 0 1px","width":"100%","position":"relative","borderStyle":"solid"}'>
