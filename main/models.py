...
class fupinxinxi(BaseModel):
    ...
    yuannianshouru=models.FloatField   (  null=True, unique=False, verbose_name='工作收入' )
    yuankezhipeishouru=models.FloatField   (  null=True, unique=False, verbose_name='其他收入' )
    xiannianshouru=models.FloatField   (  null=True, unique=False, verbose_name='生活支出' )
    xiankezhipeishouru=models.FloatField   (  null=True, unique=False, verbose_name='可支配收入' )
    kezhipeizhanbi=models.FloatField   (  null=True, unique=False, verbose_name='需要帮扶等级评定' )
